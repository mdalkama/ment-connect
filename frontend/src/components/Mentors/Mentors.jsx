    ...
    return (
        <>
            <div id='about' className='min-h-[100vh] pt-[68px] w-[100%] flex justify-evenly flex-wrap bg-[#f5f8f1]'>
                {users.map((user)=>{
                    return(
                        <Mentor user = {user} openProfileToggle={openProfileToggle} scrollToggle={scrollToggle} showProfileUpdate={showProfileUpdate}/>
                    )
                })}
...
function Mentor(props) {
    return (
        <div className='py-4 px-2'>
            <div className="bg-white rounded-2xl shadow-md min-w-72 max-w-96 p-6 hover:scale-105 transition-transform flex flex-col items-center shrink-0">
