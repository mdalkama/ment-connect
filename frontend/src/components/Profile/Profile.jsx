...
{ scroll ? document.body.style.overflow = "auto" : document.body.style.overflow = "hidden" }
  ...
  return (
    <div className='mt-[68px] py-4 flex flex-col items-center justify-start'>
      {/* profile main */}
...
function BasicInfo (props){
  return(
    <div className='mt-10 pt-1 md:pt-4 pl-4 w-[100%] md:w-[90%] gap:1 md:gap-4 md:rounded-lg  bg-[white] border-[1px] border-[#5d5d5d] flex flex-col justify-start items-center'>
      <h3 className='font-semibold md:font-bold text-xl w-full pl-1 md:pl-4'>User Info</h3>   
      <div className='pl-0 md:pl-4 w-full gap-4 py-8 rounded-lg  bg-[white] flex flex-col justify-start items-start'>
...
const education1 = props.education1;
  return (
        ...
        <div className='pl-0 md:pl-4 w-full gap-4 py-8 rounded-lg  bg-[white] flex justify-start items-center'>
          ...
          <div>
            <p className='font-bold text-sm md:text-xl'>{education1[0].name}</p>
            <p className='font-semibold text-xs md:text-lg'> {education1[0].degree} - {education1[0].field}</p>
            <p className='font-semibold text-sm md:text-lg'>{education1[0].startYear} - {education1[0].endYear}</p>
            <p className='font-semibold text-sm md:text-lg text-[#616161]'>{education1[0].location}</p>
          </div>
        </div>
        :
...
function Skills (props){
  return(
    <div className='mt-10 pt-1 md:pt-4 pl-4 w-[100%] md:w-[90%] gap:1 md:gap-4 md:rounded-lg  bg-[white] border-[1px] border-[#5d5d5d] flex flex-col justify-start items-center'>
      <h3 className='font-semibold md:font-bold text-xl w-full pl-1 md:pl-4'>Skills</h3>
      {
