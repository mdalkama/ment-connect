          ...
          <div className='h-[calc(100svh_-_188px)]  md:h-[calc(100vh_-_168px)] w-[100%] overflow-y-auto p-4 flex flex-col gap-4'>
            ...
            {messages?.map((m) => (
              ...
              >
                ...
                ${m.senderId === user.userid ? "justify-end justify-self-end bg-[#3CCE92] text-black pr-2 md:pr-20" : "justify-start justify-self-start bg-[#3CCE92] text-black pl-2  md:pr-20 md:pl-4"}`}
                >
                  {m.text}
                </p>
              </div>
